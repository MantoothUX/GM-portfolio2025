...
export default function ProjectShowcasePageWithData() {
  const sampleProject: ProjectData = {
    ...
    imageGroups: [{
      ...
      images: [{
        ...
        id: '10',
        url: 'https://images.unsplash.com/photo-1509114397022-ed747cca3f65?q=80&w=2070&auto=format&fit=crop',
        alt: 'Detail 6'
      }]
    }, {
      type: 'half',
      images: [{
        id: '11',
        url: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=2070&auto=format&fit=crop',
        alt: 'Application 1'
      }, {
        id: '12',
  ...
  return <ProjectShowcasePage project={sampleProject} onBack={handleBack} onNextProject={handleNextProject} onPrevProject={handlePrevProject} nextProjectTitle="Retro Future" prevProjectTitle="Cyber Pulse" />;
}